...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/com/camunda/avg/KundenAuftrag/ProcessTest.java) in your IDE or using:
...
<!-- Tweet
New @Camunda example: Camunda Platform Process Application - A Process Application for [Camunda Platform](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/KundenAuftrag
-->
